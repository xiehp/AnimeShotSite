...
<form class="form-horizontal" action="${ctx}/managesite/anime/submit" method="post">
	...
	<a href="${ctx}/managesite/anime/list">返回上层</a>
</form>
			...
			<div class="row">
				<c:forEach items="${ animeEpisodeList }" var="animeEpisode">
					<div class="col-lg-3 col-sm-4 col-xs-6 thumbnail">
						<a href="${ctx}/managesite/animeEpisode/view/${animeEpisode.id}">
...
<div>
	<a href="${ctx}/managesite/animeEpisode/new"> 增加剧集信息 </a>
</div>