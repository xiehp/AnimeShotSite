 ...
 * @version 1.0
 */
public final class SpringApplicationContextUtil implements ApplicationContextAware {
		...
		if (factory == null) {
			synchronized (SpringUtil.class) {
				if (factory == null) {
					...
					LOG.info("手动加载xml：" + factory + ", applicationContext.getApplicationName():" + applicationContext.getApplicationName() + ", applicationContext.getDisplayName():" + applicationContext.getDisplayName());
				}
			}
		}
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		factory = applicationContext.getAutowireCapableBeanFactory();
		LOG.info("由系统自动设置ApplicationContext：" + applicationContext);
	}
}
