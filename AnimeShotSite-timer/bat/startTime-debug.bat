...
%app_java_exe% %debug_param% -Djava.ext.dirs=%app_java_ext_lib_path%;AnimeLib;OtherLib; -Xmx400M -XX:MaxPermSize=256M -Dspring.profiles.active=production -Dlogback.configurationFile=conf/logback.xml -classpath conf;AnimeShotSite-timer-0.0.1-SNAPSHOT.jar; xie.animeshotsite.timer.main.MainTimer