...
public class WebPageTitleInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(final HttpServletRequest request, final HttpServletResponse response,
		...
		if (XStringUtils.isNotBlank(shotSiteSetup.getAnimesiteServerHost())) {
			...
			if ("127.0.0.1".equals(hostName) || "localhost".equals(hostName) || hostName.startsWith("192.168.4.") || hostName.startsWith("fengxian.acgwiki.net") || hostName.startsWith("img.acgimage.com")) {
				// 来自本地，则不做跳转
